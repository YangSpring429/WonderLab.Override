...
//experimental control, breadcrumb bar
//Use by https://github.com/yuto-trd/FluentAvalonia.BreadcrumbBar/blob/main/FluentAvalonia.BreadcrumbBar/UI/Controls/BreadcrumbBar.cs
public sealed class BreadcrumbBar : TemplatedControl {
    ...
    public BreadcrumbBar() {
        ...
        _dataProvider.OnRawDataChanged(OnDataSourceChanged);
    }
    ...
    internal void OpenFlyout() {
        object[] hiddenElements = [.. _dataProvider.GetOverflowItems()];
